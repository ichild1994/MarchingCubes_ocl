...
public:
    ...
    void        set2(const float src[16]);
    void        set2(float xx, float xy, float xz, float xw,
                    float yx, float yy, float yz, float yw,
                    float zx, float zy, float zz, float zw,
                    float wx, float wy, float wz, float ww);
    void        setRowState(int index, const float row[4]);
    void        setRowState(int index, const Vector4& v);
    void        setRowState(int index, const Vector3& v);
	...
	void setPerspectiveY(float fovy, float aspect, float zNear, float zFar);
	void setPerspectiveX(float fovx, float aspect, float zNear, float zFar);
...
inline Matrix4::Matrix4(float xx, float xy, float xz, float xw,
                        ...
                        float wx, float wy, float wz, float ww)
{
    set2(xx, xy, xz, xw,  yx, yy, yz, yw,  zx, zy, zz, zw,  wx, wy, wz, ww);
}



inline void Matrix4::set2(const float src[16])
{
    m[0] = src[0];  m[1] = src[1];  m[2] = src[2];  m[3] = src[3];
...
inline void Matrix4::set2(float xx, float xy, float xz, float xw,
                         float yx, float yy, float yz, float yw,
                         float zx, float zy, float zz, float zw,
                         float wx, float wy, float wz, float ww)
{
...
inline void Matrix4::setRowState(int index, const float row[4])
{
...
inline void Matrix4::setRowState(int index, const Vector4& v)
{
...
inline void Matrix4::setRowState(int index, const Vector3& v)
{
...
inline Matrix4& Matrix4::zero() {
	m[0] = m[5] = m[10] = m[15] = m[1] = m[2] = m[3] = m[4] = m[6] = m[7] = m[8] = m[9] = m[11] = m[12] = m[13] = m[14] = 0.0f;
	return *this;
}
